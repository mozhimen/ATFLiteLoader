 ...
 * @Version 1.0
 */
abstract class TFLiteLoaderLabel(
    modelPath: String,
    labelPath: String,
        ...
        fun create(
            ...
            return when (modelType) {
                ModelType.QUANTIZED_MOBILENET -> {
                    TFLiteLoaderLabelQuantizedMobileNet(modelPath, labelPath, resultSize, chipType, numThreads)
                }
                ModelType.FLOAT_MOBILENET -> {
                    TFLiteLoaderLabelFloatMobileNet(modelPath, labelPath, resultSize, chipType, numThreads)
                }
                ModelType.FLOAT_EFFICIENTNET -> {
                    TFLiteLoaderLabelFloatEfficientNet(modelPath, labelPath, resultSize, chipType, numThreads)
                }
                ModelType.QUANTIZED_EFFICIENTNET -> {
                    TFLiteLoaderLabelQuantizedEfficientNet(modelPath, labelPath, resultSize, chipType, numThreads)
                }
            }
        }
    }
